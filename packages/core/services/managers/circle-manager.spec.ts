...
describe('CircleManager', () => {
  ...
  describe('Create a new circle', () => {
    it('should call the mapsApiWrapper when creating a new circle',
       inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
  ...
  describe('Delete a circle', () => {
    it('should set the map to null when deleting a existing circle',
       inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
             ...
             const circleInstance: any = {setMap: jest.fn()};
             (<jest.Mock>apiWrapper.createCircle).mockReturnValue(Promise.resolve(circleInstance));
  ...
  describe('Set radius option', () => {
    it('should update that circle via setRadius method when the radius changes',
       fakeAsync(inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
             ...
             const circleInstance: Circle = <any>{setMap: jest.fn(), setRadius: jest.fn()};
             (<jest.Mock>apiWrapper.createCircle).mockReturnValue(Promise.resolve(circleInstance));
             circleManager.addCircle(newCircle);
  ...
  describe('Set options', () => {
    it('should update that circle via setOptions method when the opacity options change',
       fakeAsync(inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
             ...
             const circleInstance: any = {setMap: jest.fn(), setOptions: jest.fn()};
    ...
    it('should update that circle via setOptions method when the color options change',
       fakeAsync(inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
    ...
    it('should update that circle via setOptions method when the strokeWeight/position change',
       fakeAsync(inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
    ...
    it('should update that circle via setVisible method when the visible changes',
       fakeAsync(inject(
           [CircleManager, GoogleMapsAPIWrapper],
           (circleManager: CircleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newCircle = new AgmCircle(circleManager);
             ...
             const circleInstance: any = {setMap: jest.fn(), setVisible: jest.fn()};
             (<jest.Mock>apiWrapper.createCircle).mockReturnValue(Promise.resolve(circleInstance));
             circleManager.addCircle(newCircle);
